...
class SingleProfileViewPage extends StatefulWidget {
  final ProfileModel profile;
  const SingleProfileViewPage({Key? key,required this.profile}) : super(key: key);

  @override
  _SingleProfileViewPageState createState() => _SingleProfileViewPageState();
}

class _SingleProfileViewPageState extends State<SingleProfileViewPage> {
